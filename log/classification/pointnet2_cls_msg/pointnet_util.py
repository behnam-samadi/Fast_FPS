...
def binary_search(sorted_points, origin, margin):
  ...
  while(left < right):
    ...
    center = int((left+right)/2)
    #print("\n--------\n")
    #print(center, sorted_points[center])
    #print(left, sorted_points[left])
    #print(right, sorted_points[right])
    #print(expected)
...
def farthest_point_sample(xyz, npoint):
    ...
    #initial_point = torch.randint(1, N-1,(1,) ,dtype=torch.long).to(device).numpy()
    initial_point = np.random.randint(1, N-1)
    ...
    #scores[0] = torch.abs(sorted_points[initial_point]- sorted_points[0]).numpy()
    #scores[-1] = torch.abs(sorted_points[initial_point]- sorted_points[-1]).numpy()
    ...
    for i in range(npoint - 1):
      ...
      if not index == (len(centroids)-1):
        ...
        scores[candidate_right] = abs(sorted_points[selected_centroid]-sorted_points[candidate_right])
      if not index == 0:
        candidate_left = indices[binary_search(sorted_points, selected_centroid, centroids[index-1])]
        candidates.add(candidate_left)
        scores[candidate_left] = abs(sorted_points[selected_centroid]-sorted_points[candidate_left])
    ...
    #print( (torch.abs(sorted_points[initial_point]- sorted_points[-1]) < torch.abs(sorted_points[initial_point]- sorted_points[0])).numpy()[0])
    #print(initial_point, "initial_point")
    #print("----------------\n")
    #print(sorted_points[initial_point])
    #print(sorted_points[0])
    #print(sorted_points[-1])
    #print("injaaaaaaaaaa-----------")
    #print(sorted_points[initial_point], sorted_points[-1], sorted_points[0])
    #print(sorted_points[initial_point]- sorted_points[-1])
    #print(sorted_points[initial_point]- sorted_points[0])
    #print("in bood")
    
    if (torch.abs(sorted_points[initial_point]- sorted_points[-1]) < torch.abs(sorted_points[initial_point]- sorted_points[0])).numpy()[0]:
      centroids[1] = 0
      candidates.add(N)
    else:
      centroids[1] = N
    ...
    print("\n", initial_point.shape, "shape")
    print("sorted:", sorted_points.shape)
