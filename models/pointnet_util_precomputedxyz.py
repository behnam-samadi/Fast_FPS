...
def farthest_point_sample(xyz, npoint):
    ...
    #print(type(npoint))
    #raise(False)
    #indices1 = indices[:, 0:int(npoint/2)]
    #indices2 = indices[:, -(int(npoint/2)):]
    #return_indices = torch.cat((indices1,indices2), 1)
    ...
    for i in range(npoint):
        ...
        #using precomputed:
        centroid = torch.sum(centroid, -1)
        dist = torch.abs((sum_dims - centroid))
        #M.dist:
    ...
    #print("return indices properties")
    #print(return_indices.shape)
    #print(return_indices.dtype)
    return centroids
