...
def farthest_point_sample(xyz, npoint):
    ...
    for i in range(npoint - 1):
      ...
      #print("the centroid number", selected_centroid, "\n")
      #print("------inja----")
      #print("\n",selected_centroid)
      ...
      if not index == (len(centroids)-1):
        ...
        #scores[candidate_right] = max(abs(sorted_points[candidate_right] - sorted_points[selected_centroid]),abs(sorted_points[centroids[index+1]]- sorted_points[selected_centroid]))
        #abs(sorted_points[selected_centroid]-sorted_points[candidate_right])
      if not index == 0:
